...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Messages = __webpack_require__(235);
	...
	var store = createStoreWithMiddleware((0, _index2.default)(initialState));
	...
	_reactDom2.default.render(_react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(_reactRouter.Route, { path: 'test', component: _Name2.default }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mapValues = __webpack_require__(211);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
		var initialState = arguments.length <= 0 || arguments[0] === undefined ? state : arguments[0];

		function messages() {
			var currentMessages = arguments.length <= 0 || arguments[0] === undefined ? initialState.messages : arguments[0];
			var action = arguments[1];

			var messages = currentMessages.map(function (message) {
			...
			switch (action.type) {
				case _messageActions.ADD_MESSAGE:
					...
					break;
				case _messageActions.GET_MESSAGES:
		...
		function profile() {
			var oldProfile = arguments.length <= 0 || arguments[0] === undefined ? initialState.profile : arguments[0];
			var action = arguments[1];

			var profile = Object.assign({}, oldProfile);
			switch (action.type) {
				case _profileActions.UPDATE_NAME:
		...
		return (0, _redux.combineReducers)({ messages: messages, profile: profile });
	};

	var _redux = __webpack_require__(207);

	var _messageActions = __webpack_require__(225);

	var _profileActions = __webpack_require__(229);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.GET_MESSAGES = exports.ADD_MESSAGE = undefined;
	...
	var GET_MESSAGES = exports.GET_MESSAGES = 'get-message';
	...
	function requestMessages() {
		return function (dispatch) {
			return (0, _superagent2.default)('GET', '/api/v1/messages').end(function (err, data) {
	...
	function createMessage(message) {
		return function (dispatch) {
			...
			return _superagent2.default.post('/api/v1/messages').set('Content-Type', 'application/json').send('{"message":' + '"' + message + '"}').end();
		};
	}
...
/***/ function(module, exports) {
	...
	var UPDATE_NAME = exports.UPDATE_NAME = 'update-name';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var profileActionCreators = _interopRequireWildcard(_profileActions);

	var _ProfileName = __webpack_require__(234);
		...
		_createClass(Profile, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_ProfileName2.default, { name: this.props.profile.name, onSubmit: this.props.updateName })
				);
			}
		}]);
	...
	function mapDispatchToProps(dispatch) {
		return (0, _redux.bindActionCreators)(profileActionCreators, dispatch);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function handleKeyPress(ev) {
		if (ev.which === 13) {
			var trimmedName = ev.target.value.trim();
	...
	var ProfileName = (function (_Component) {
		_inherits(ProfileName, _Component);

		function ProfileName() {
			_classCallCheck(this, ProfileName);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(ProfileName).apply(this, arguments));
		}
		...
		_createClass(ProfileName, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement('input', { type: 'text', defaultValue: this.props.name, onKeyPress: handleKeyPress.bind(this) })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MessageList = __webpack_require__(236);

	var _MessageList2 = _interopRequireDefault(_MessageList);

	var _MessageBox = __webpack_require__(237);
		...
		_createClass(Messages, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_MessageBox2.default, { onSubmit: this.props.createMessage }),
					_react2.default.createElement(
						'div',
						{ onClick: this.props.requestMessages },
						'Click me'
					)
				);
			}
	...
	var MessageBox = (function (_Component) {
		...
		_createClass(MessageBox, [{
			...
			value: function handleKeyPress(ev) {
				if (ev.which === 13) {
					var trimmedMessage = ev.target.value.trim();
